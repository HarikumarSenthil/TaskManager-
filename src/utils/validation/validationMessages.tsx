const validationMessages: Record<string, string> = {
    ...
    isValidLeaveReason:'Leave reason is too short. It should be at least 20 characters',
    isPassValid:"Please enter 8 digit letter with upercase letter ,special character and number"
};
